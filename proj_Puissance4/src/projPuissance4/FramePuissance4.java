...
public class FramePuissance4 extends Frame {
	...
	public FramePuissance4(Jeu jeu) {
		this.jeu = jeu;
		canvas = new CanvasPuissance4(jeu);
		canvas.addKeyListener(new CanvasPuissance4KeyListener(jeu, this));
		canvas.addMouseListener(new CanvasPuissance4MouseListener(jeu, this));
